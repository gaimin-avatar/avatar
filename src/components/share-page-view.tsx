...
export function SharePageView({ payload }: { payload: SharePayload | null }) {
  ...
  const shareText = useMemo(() => {
    ...
    return `Just became a ${payload.styleName} on GAIMIN Avatar AI. Made with GAIMIN Avatar AI. Create yours: ${origin || "https://avatar.gaimin.gg"}`;
  }, [origin, payload]);
